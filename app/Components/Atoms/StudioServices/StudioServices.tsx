    ...
    <div className="relative inline-block w-1/2  text-white font-sans">
      <div className="group relative mb-2 cursor-pointer p-3 text-[31px] font-bold">
        ...
        <div
          ...
          className="bg-image3 bg-center bg-cover absolute left-[150%] w-72 h-96 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none flex justify-center items-center"
        >
