...
const Project = () => {
  return (
    <div className='font-supreme'>
        <div
            className="w-[550px] h-[408px] relative bg-image1 bg-cover grayscale group hover:grayscale-0 font-supreme transition-all duration-300 ease-out cursor-pointer"
            style={{
        ...
        <div
            ...
            style={{
                background: 'linear-gradient(to right, rgba(255, 255, 0, 1) 0%, rgba(255, 255, 0, 1) 80%, rgba(229, 229, 72, 0.3) 80%, rgba(229, 229, 72, 0.2) 100%)',
            }}
        >
